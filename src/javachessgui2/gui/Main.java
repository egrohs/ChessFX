...
public class Main extends Application {
	...
	final static String scroll_pane_style = "-fx-border-width: 10px;" + "-fx-border-radius: 10px;"
			+ "-fx-border-style: solid;" + "-fx-border-color: #afafff;";
	...
	public static void system_message(String what, int set_timer) {
		...
		webEngine.loadContent("<body style=\"background-color: #efefff;font-size: 20px;font-family: monospace;\">"
				+ what + "</body>");
